...
import scraml.{DefnWithCompanion, LibrarySupport, MetaUtil, ModelGen, ModelGenContext}
...
object RefinedSupport extends LibrarySupport {
  ...
  sealed abstract class RefinedPropertyMatching[A] extends TypeNaming {
    ...
    final def unapply(declaration: Decl.Def)(
    ...
    final def unapply(param: Term.Param)(
      implicit context: ModelGenContext
    ): Option[A] = {
    ...
    protected def array(name: Name, descriptor: ArrayType, optional: Boolean)(
      implicit context: ModelGenContext
    ): Option[A] = None

    protected def number(name: Name, descriptor: NumberType, optional: Boolean)(
      implicit context: ModelGenContext
    ): Option[A] = None

    protected def string(name: Name, descriptor: StringType, optional: Boolean)(
      implicit context: ModelGenContext
    ): Option[A] = None

    protected def numberBounds(min: Option[BigDecimal], max: Option[BigDecimal]): List[Type.Apply] = {
      (min, max) match {
    ...
    private def dispatch(name: Name, propertyType: Option[AnyType], required: Boolean)(
      implicit context: ModelGenContext
    ): Option[A] = {
      propertyType match {
  ...
  object RefinedPropertyDeclaration extends RefinedPropertyMatching[(Type, Option[Term])] {
    override protected def array(name: Name, descriptor: ArrayType, optional: Boolean)(
      implicit context: ModelGenContext
    ...
    override protected def number(name: Name, descriptor: NumberType, optional: Boolean)(
      implicit context: ModelGenContext
    ): Option[(Type, Option[Term])] =
      Some(
    ...
    override protected def string(name: Name, descriptor: StringType, optional: Boolean)(
      implicit context: ModelGenContext
    ): Option[(Type, Option[Term])] =
      Some(
        mkDeclType(context.objectType, name.value) -> defaultValue(optional) {
  ...
  object RefinedPropertyItemPredicates extends RefinedPropertyMatching[List[Type.Apply]] {
    def apply(declaration: Decl.Def)(
      implicit context: ModelGenContext
    ): Option[List[Type.Apply]] =
      unapply(declaration)

    def apply(param: Term.Param)(
      implicit context: ModelGenContext
    ): Option[List[Type.Apply]] =
      unapply(param)
  ...
  object RefinedPropertyType extends RefinedPropertyMatching[(Type.Name, Option[Type.Name], Boolean)] {
    override protected def array(name: Name, descriptor: ArrayType, optional: Boolean)(
      implicit context: ModelGenContext
  ...
  private def declareRefinements(classDef: Defn.Class)(
    implicit context: ModelGenContext
  ): Defn.Class = {
  ...
  private def declareRefinements(traitDef: Defn.Trait)(
    implicit context: ModelGenContext
  ): Defn.Trait = {
  ...
  private def defineRefinements(classDef: Defn.Class, companion: Defn.Object)(
    implicit context: ModelGenContext
  ): Defn.Object = {
    val types = generatePropertiesCode(classDef) {
      prop =>
        ...
        val originalType = ModelGen.scalaTypeRef(
          propDef.getType,
          optional = false,
  ...
  private def defineRefinements(traitDef: Defn.Trait, companion: Defn.Object)(
    implicit context: ModelGenContext
  ): Defn.Object = {
  ...
  private def predicates(prop: Decl.Def)(
    implicit context: ModelGenContext
  ): Type = {
    prop match {
  ...
  private def predicates(prop: Term.Param)(
    implicit context: ModelGenContext
  ): Type = {
    prop match {
      case RefinedPropertyPredicates(one :: Nil) =>
