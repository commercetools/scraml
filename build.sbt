...
lazy val root = (project in file("."))
  ...
  .settings(
    ...
    libraryDependencies += "com.softwaremill.sttp.tapir" %% "tapir-core" % "0.19.0-M8" % Test,
    libraryDependencies += "com.softwaremill.sttp.tapir" %% "tapir-json-circe" % "0.19.0-M8" % Test,
